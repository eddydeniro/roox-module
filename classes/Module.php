...
{   
    ...
    {             
        global $module_table, $plugin_name;
        ...
        $code_query = db_query("SELECT * FROM $module_table WHERE is_folder=0 and is_active=1 " . ($exclude_code_id ? " AND id!=" . $exclude_code_id : "") );
    ...
    static function get_tree($parent_id = 0, $tree = array(), $level = 0)
    {
        ...
        $code_query = db_query("SELECT * FROM $module_table WHERE parent_id=" . $parent_id . " ORDER BY sort_order, name");
